...
import ChartsHandling from "./Charts_handling/ChartsHandling";
      ...
      <div className={stylings[theme].introSection.parent}>
        <div className=" w-full h-fit flex  py-[3rem] items-center justify-evenly shrink-0">
          <div className="flex w-1/2 flex-col items-start h-full justify-start">
            <h1 className={stylings[theme].introSection.heading}>
              {selectedOption
                ...
                : `Building Load Profile Analysis`}
          ...
          {expandImg ? (
            ...
            >
              <div className=" w-[50%] top-[50%] left-[50%] absolute translate-x-[-50%] translate-y-[-50%] h-fit shrink-0">
                <img
                  src={
                    assets[
                      selectedOption
          ...
          <div className="w-[33rem] gap-[2rem] shrink-0 overflow-y-visible overflow-x-clip flex items-start justify-center flex-col">
            <div
              className={
                stylings[theme].introSection.fileSelectorPack.toggleContainer
              }
            >
              <motion.div
                variants={{
                ...
                className={
                  stylings[theme].introSection.fileSelectorPack.toggleBg
                }
              ></motion.div>
              <button
                style={{ color: !toggle ? "white" : undefined }}
                onClick={() => {
                  setToggle(false);
                }}
                className={stylings[theme].introSection.fileSelectorPack.button}
              >
                CCNY Buildings
              </button>
              <button
                ...
                className={`${stylings[theme].introSection.fileSelectorPack.button} border-r-[0rem]`}
              >
                Upload Your Own
              </button>
            </div>
            <div
              style={{ transform: `translateX(${toggle ? "-50%" : 0})` }}
              className=" w-[200%] duration-200 ease-in-out h-fit shrink-0 flex items-center justify-start"
            >
              <div className=" w-[50%] relative shrink-0 gap-[1rem] flex items-center justify-center">
                ...
                >
                  {selectedOption && (
                    <img
                      ...
                      alt="img"
                      className=" w-[5rem] cursor-pointer h-[5rem] rounded-full object-cover"
                    />
                  )}
                  <div
                    className={
                  ...
                  >
                    ...
                    >
                      ...
                      <span
                        ...
                        style={{
                          transform: `rotate(${!rollDown ? 0 : 90}deg)`,
                        }}
                      >
                        <SVGComponent
                          {...stylings[theme].introSection.fileSelectorPack
                ...
                <motion.div
                  ref={rollDownContianer}
                  tabIndex={-1}
                  onBlur={(event) => {
                    if (
                      rollDownContianer.current &&
                  ...
                  animate={rollDown ? "rollDown" : "rollUp"}
                  onScroll={(e) => {
                    e.stopPropagation();
                  }}
                  className={
                ...
                >
                  {fileData.map((val) => {
                    return (
                      <motion.button
                        variants={{
                          rollDown: { opacity: 1, x: 0 },
                          rollUp: { opacity: 0, x: 50 },
                        }}
                        onClick={() => {
              ...
              >
                <div className=" relative w-[30%]">
                  <input
                    ...
                    id="alias"
                    className={
                      stylings[theme].introSection.fileSelectorPack.form.input
                    }
                  />
                  <label
                    htmlFor="alias"
                    className={
                      stylings[theme].introSection.fileSelectorPack.form.label
                    }
                  >
                    Name
                  </label>
                ...
                <div className=" w-[30%] shrink-0">
                  <label
                    ...
                    className={
                      stylings[theme].introSection.fileSelectorPack.form
                        .selectLabel
                    }
                  >
                    {fName ? fName : "Choose File"}
                  </label>
                  <input
                    type="file"
                    className="hidden"
                ...
                <button
                  ...
                  className={`${stylings[theme].introSection.fileSelectorPack.form.button}`}
                >
                  {uploadFileUnderProcess ? (
                    <div className=" w-[1.7rem] h-[1.7rem] rounded-full shrink-0 border-[0.1rem] border-y-blue-900 border-x-white animate-spin"></div>
                  ) : (
                    "Submit"
                  )}
                </button>
        ...
        <div className=" w-full h-[4rem] flex items-start gap-[.2rem]">
          ...
          <img
            src={assets.buildingsBG1}
            alt="img"
            className=" w-[25%] h-full"
          />
          <img
            src={assets.buildingsBG2}
            alt="img"
            className=" w-[25%] h-full"
          />
          <img
            src={assets.buildingsBG3}
            alt="img"
            className=" w-[25%] h-full"
          />
      ...
      {selectedOption ? (
        <>
          <NumbersData
            ...
            setBessPower={setBessPower}
            setBessCost={setBessCost}
          />
          <ChartsHandling
