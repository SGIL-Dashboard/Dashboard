export const stylings = {
    ...
    {
     navbar : {
      container : "w-full bg-blue-100 h-fit shrink-0 flex items-center justify-between px-[3rem] py-[1.2rem]",
    ...
    dark : {
     navbar : {
      container : "w-full bg-black h-fit shrink-0 flex items-center justify-between px-[3rem] py-[1.2rem]",
      text : "text-[2rem] font-semibold text-white",
     ...
     chartSelection : {
      parent : " w-full flex items-start justify-between bg-gray-800 border-b-[0.15rem] border-slate-200",
      chartSelectorContainer : {
